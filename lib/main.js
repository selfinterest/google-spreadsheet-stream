...
/**
 * Sets up some defaults on the stream factory, checking to make sure sufficient options on the factory have been set.
 * @param streamObject
 */
function setupStreamFactoryForAnyType(streamFactory){
...
GsStreamFactory.prototype.createStream = function(streamOptions){
  ...
  setupStreamFactoryForAnyType(this);
